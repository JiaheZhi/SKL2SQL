...
save_model(category_encoders, '/root/volume/SKL2SQL/trained_model/category_encoders_usa_rf5_4catenc_weather_condition.joblib')
...
save_model(pipeline, '/root/volume/SKL2SQL/trained_model/usa_rf_dp5_4catenc_weather_condition.joblib')
...
category_encoders = load_model('/root/volume/SKL2SQL/trained_model/category_encoders_usa_rf5_4catenc_weather_condition.joblib')
# Frequency Encoder
