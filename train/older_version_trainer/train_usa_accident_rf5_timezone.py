...
category_encoders_path = '/root/volume/SKL2SQL/trained_model/category_encoders_usa_rf5_4catenc_timezone.joblib'
save_model(category_encoders, category_encoders_path)
...
save_model(pipeline, '/root/volume/SKL2SQL/trained_model/usa_rf_dp5_4catenc_timezone.joblib')
...
category_encoders = load_model(category_encoders_path)
# Frequency Encoder
