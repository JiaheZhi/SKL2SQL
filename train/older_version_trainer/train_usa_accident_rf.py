...
X['Visibility(mi)'] = pd.cut(X['Visibility(mi)'], bins=[0, 10, 20 ,30, 1000], labels=[1,2,3,4])
...
dump(pipeline, '/root/volume/SKL2SQL/trained_model/usa_accident_rf_pipeline_deep8_no_udf.joblib')
