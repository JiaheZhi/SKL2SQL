            ...
            WHEN "Engine" <= 1999.0 THEN CASE
                WHEN "Year" <= 2015.0 THEN CASE
                    WHEN "Year" <= 2013.0 THEN CASE
                        ...
                        END
                        ELSE CASE
                            WHEN "Year" <= 2010.0 THEN 1.53485
                            ELSE 2.80284
                        END
                    END
                    ELSE CASE
                        WHEN "Power" <= 105.0 THEN CASE
                            WHEN "Engine" <= 1198.0 THEN 2.60431
                            ELSE 4.08556
                        END
                        ELSE CASE
                            WHEN "Name" in (
                ...
                ELSE CASE
                    WHEN "Power" <= 105.0 THEN CASE
                        WHEN "Power" <= 73.94 THEN CASE
                            WHEN "Power" <= 63.12 THEN 3.16965
                            ELSE 4.30899
                        END
                        ELSE CASE
                            WHEN "Year" <= 2017.0 THEN 5.20812
                            ELSE 6.82573
                        END
                    END
                    ELSE CASE
            ...
            ELSE CASE
                WHEN "Transmission" <> 'Manual' THEN CASE
                    WHEN "Year" <= 2018.0 THEN CASE
                        ...
                        END
                        ELSE CASE
                            WHEN "Kilometers_Driven" <= 60000.0 THEN 17.61298
                            ELSE 13.59421
                        END
                    END
                    ELSE CASE
                        WHEN "Mileage" <= 13.1 THEN CASE
                            WHEN "Kilometers_Driven" <= 22894.8 THEN 35.0
                            ELSE 51.11333
                        END
                        ELSE CASE
                ...
                ELSE CASE
                    ...
                    ELSE CASE
                        WHEN "Name" in (
                            ...
                            WHEN "Year" <= 2018.0 THEN 12.61882
                            ELSE 16.36226
                        END
                        ELSE CASE
                            WHEN "Name" in (
            ...
            WHEN "Year" <= 2016.0 THEN CASE
                WHEN "Seats" <= 5.0 THEN CASE
                    WHEN "Engine" <= 2835.0 THEN CASE
                        WHEN "Brand" <= 201.5 THEN CASE
                            WHEN "Kilometers_Driven" <= 14910.0 THEN 31.07
                            ELSE 21.33333
                        END
                        ELSE CASE
                    ...
                    END
                    ELSE CASE
                        WHEN "Kilometers_Driven" <= 14910.0 THEN CASE
                            WHEN False THEN 47.5
                            ELSE 105.0
                        END
                        ELSE CASE
                ...
                ELSE CASE
                    WHEN "Year" <= 2013.0 THEN CASE
                        ...
                        END
                        ELSE CASE
                            WHEN "Kilometers_Driven" <= 65000.0 THEN 21.79
                            ELSE 13.13824
                        END
                    END
                    ELSE CASE
                ...
                WHEN "Power" <= 193.64000000000033 THEN CASE
                    WHEN "Kilometers_Driven" <= 60000.0 THEN CASE
                        WHEN "Seats" <= 7.0 THEN CASE
                            WHEN "Engine" <= 2179.0 THEN 29.07468
                            ELSE 37.59143
                        END
                        ELSE CASE
                    ...
                    ELSE CASE
                        WHEN "Name" in (
                            ...
                            WHEN "Kilometers_Driven" <= 78500.0 THEN 26.1868
                            ELSE 20.3475
                        END
                        ELSE CASE
                ...
                ELSE CASE
                    WHEN "Name" in (
                        ...
                        WHEN "Name" in (
                            ...
                            WHEN "Kilometers_Driven" <= 34687.2 THEN 47.16118
                            ELSE 32.213
                        END
                        ELSE CASE
                            WHEN "Brand" <= 551.0 THEN 53.58203
                            ELSE 20.108
                        END
                    END
                    ELSE CASE
                        ...
                        END
                        ELSE CASE
                            WHEN "Kilometers_Driven" <= 45000.0 THEN 43.6
                            ELSE 54.69
                        END
                    END
                END
