...
if __name__ == '__main__':
    ...
    model_file = '/root/volume/SKL2SQL/trained_model/usa_rf_dp5_4catenc_source.joblib'
    ...
    queries, query = manager.generate_query(model_file, dataset_name, features, dbms, pre_sql
                                            ...
                                            encoders_path='/root/volume/SKL2SQL/trained_model/category_encoders_usa_rf5_4catenc_source.joblib')
