...
if __name__ == '__main__':
    ...
    model_file = '/root/volume/SKL2SQL/trained_model/usa_accident_dt_deep5.joblib'
    ...
    with open('/root/volume/SKL2SQL/experiments/usa_accident_dt_deep5/usa_accident_dt_deep5_join.sql', 'w') as sql_file:
