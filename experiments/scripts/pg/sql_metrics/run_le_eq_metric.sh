...
# Python脚本名称
python_script="/root/volume/SKL2SQL/experiments/scripts/pg/sql_metrics/gen_le_eq_metric_sql.py"
...
# CSV文件名
csv_file="/home/postgres/SKL2SQL/experiments/scripts/pg/sql_metrics/le_eq_metric.csv"
...
for length in "${lengths[@]}"; do
    ...
    sql_file="/home/postgres/SKL2SQL/experiments/scripts/pg/sql_metrics/le_eq_metric.sql"
