...
# Python脚本名称
python_script="/root/volume/SKL2SQL/experiments/scripts/pg/sql_metrics/gen_ge_metric_sql.py"
...
# CSV文件名
csv_file="/home/postgres/SKL2SQL/experiments/scripts/pg/sql_metrics/ge_metric.csv"
...
for length in "${lengths[@]}"; do
    ...
    sql_file="/home/postgres/SKL2SQL/experiments/scripts/pg/sql_metrics/ge_metric.sql"
