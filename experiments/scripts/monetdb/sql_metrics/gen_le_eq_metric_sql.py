...
# 创建一个解析器对象
parser = argparse.ArgumentParser(description='le eq metric sql 的生成')
...
sql_file_path = "/home/postgres/SKL2SQL/experiments/scripts/monetdb/sql_metrics/le_eq_metric.sql"
