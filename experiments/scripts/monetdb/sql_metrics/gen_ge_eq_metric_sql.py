...
# 创建一个解析器对象
parser = argparse.ArgumentParser(description='ge eq metric sql 的生成')
...
sql_file_path = "/home/postgres/SKL2SQL/experiments/scripts/monetdb/sql_metrics/ge_eq_metric.sql"
