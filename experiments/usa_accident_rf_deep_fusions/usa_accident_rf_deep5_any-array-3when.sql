          ...
          CASE
            WHEN "Station" <= 0.5 THEN CASE
              WHEN "Traffic_Signal" <= 0.5 THEN CASE
                WHEN "Source" = any (array ['Source2', 'Source3']) THEN CASE
                  WHEN "Source" = any (array ['Source3']) THEN CASE
              ...
              ELSE CASE
                WHEN "Timezone" <> 'US/Pacific' THEN CASE
                  WHEN "Pressure(in)" <= 59.36127705320241 THEN CASE
                    WHEN "Source" = any (array ['Source3']) THEN 1.0
                    ELSE 1.0
                  END
                  ELSE CASE
          ...
          CASE
            ...
            ELSE CASE
              WHEN "Stop" <= 0.5 THEN CASE
                WHEN "Traffic_Signal" <= 0.5 THEN CASE
                  WHEN "Timezone" <> 'US/Central' THEN CASE
                    WHEN "Source" = any (array ['Source2', 'Source3']) THEN 1.0
                    ELSE 1.0
                  END
                  ELSE CASE
