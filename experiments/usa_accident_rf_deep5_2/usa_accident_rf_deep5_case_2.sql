    ...
    FROM
      (
        SELECT
          CASE
            WHEN "Station" <= 0.5 THEN CASE
              WHEN "Traffic_Signal" <= 0.5 THEN CASE
                WHEN "Source" <= 243999.0 THEN CASE
                  WHEN "Source" <= 49910.5 THEN CASE
              ...
              ELSE CASE
                ...
                END
                ELSE CASE
                  WHEN "Source" <= 562510.5 THEN CASE
                    WHEN "Source" <= 275457.5 THEN 1.0
                    ELSE 1.0
                  END
                  ELSE CASE
          ...
          CASE
            WHEN "Source" <= 243999.0 THEN CASE
              WHEN "Source" <= 226073.0 THEN CASE
          ...
          CASE
            ...
            ELSE CASE
              WHEN "Source" <= 243999.0 THEN CASE
                WHEN "Station" <= 0.5 THEN CASE
                  WHEN "Source" <= 34182.0 THEN CASE
                    WHEN "Traffic_Signal" <= 0.5 THEN 1.0
                    ELSE 1.0
                  END
                  ELSE CASE
                    WHEN "Source" <= 226073.0 THEN 1.0
                    ELSE 1.0
                  END
                END
                ELSE CASE
