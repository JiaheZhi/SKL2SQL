...
with open('/root/volume/SKL2SQL/experiments/results/pg/usa_accident_rf_deep5_frequency_compration_thread{}_pg.txt'.format(thread), 'r') as file:
    for line in file:
...
# 保存图像到 JPEG 文件
plt.savefig('/root/volume/SKL2SQL/experiments/results/pg/usa_accident_rf_deep5_frequency_compration_thread{}.png'.format(thread))
