...
with open('/root/volume/SKL2SQL/experiments/results/pg/usa_accident_rf_deep5_frequency_compration2_thread{}_pg.txt'.format(thread), 'r') as file:
    for line in file:
...
# 构建二维数组
array = [[data[fusion][last_number] / 1000 for last_number in last_numbers] for fusion in fusions]
...
# 保存图像到 JPEG 文件
plt.savefig('/root/volume/SKL2SQL/experiments/results/pg/usa_accident_rf_deep5_frequency_compration2_thread{}.png'.format(thread))
