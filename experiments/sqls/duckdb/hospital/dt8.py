...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Hospital/hospital_dt.joblib"
    table_name = "hospital"
    dbms = 'duckdb'
    ...
    # for group in ('org', 'pos', 'uncertain', 'prune'):
        ...
        generated_file_path = os.path.join(parent_directory, f"q4_dt8_{group}.sql")
