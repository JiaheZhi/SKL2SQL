  ...
  (
    SELECT
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.474736000000
            ELSE 0.351910000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.208565333333
            ELSE 0.334470000000
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475150000000
            ELSE 0.351596666667
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207800666667
            ELSE 0.339090000000
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.474700666667
            ELSE 0.351702000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207568000000
            ELSE 0.338298000000
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.474119333333
            ELSE 0.352156666667
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.206617333333
            ELSE 0.337051333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.473860666667
            ELSE 0.352434666667
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207030666667
            ELSE 0.340437333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475391333333
            ELSE 0.351362000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.208060666667
            ELSE 0.336852666667
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475298666667
            ELSE 0.349896000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.208244666667
            ELSE 0.338026666667
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.473616666667
            ELSE 0.353314000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.206835333333
            ELSE 0.338517333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.473917333333
            ELSE 0.352297333333
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.206344666667
            ELSE 0.339706666667
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.473934000000
            ELSE 0.350593333333
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207203333333
            ELSE 0.338500666667
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.474370666667
            ELSE 0.354535333333
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207731333333
            ELSE 0.339726000000
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475708000000
            ELSE 0.350477333333
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.207700666667
            ELSE 0.341361333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475740666667
            ELSE 0.351668666667
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.206721333333
            ELSE 0.337895333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.475352000000
            ELSE 0.352184000000
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.206848666667
            ELSE 0.336409333333
          END
        END
        ELSE CASE
      ...
      CASE
        WHEN "rcount" <> '0' THEN CASE
          WHEN "rcount" <> '1' THEN CASE
            WHEN "rcount" <> '2' THEN 0.474592666667
            ELSE 0.354935333333
          END
          ELSE CASE
            WHEN "facid" <> 'E' THEN 0.208048666667
            ELSE 0.337843333333
          END
        END
        ELSE CASE
