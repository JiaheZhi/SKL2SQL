...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Hospital/hospital_rf.joblib"
    table_name = "hospital"
    dbms = 'duckdb'
    ...
    # for group in ('org', 'pos', 'uncertain', 'prune', 'enum',):
        ...
        # generated_file_path = os.path.join(parent_directory, f"q3_rf_{group}.sql")
