...
SELECT
      CASE
        WHEN  COALESCE("Power", 74.0) <= 150.0 THEN CASE
          WHEN COALESCE("Engine", 1197.0) >= 24.000000000000
          AND COALESCE("Engine", 1197.0) < 1968.0 THEN CASE
            WHEN COALESCE("Year", 2014.0) >= 1998.0
            AND COALESCE("Year", 2014.0) < 2014.0 THEN CASE
              WHEN COALESCE("Year", 2014.0) >= 1998.0
              AND COALESCE("Year", 2014.0) < 2011.0 THEN CASE
                WHEN  COALESCE("Power", 74.0) <= 105.0 THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2008.0 THEN 0.460000000000
                  ELSE 0.751033333333
                END
                ELSE CASE
              ...
              ELSE CASE
                WHEN "Name" <> 'BMW 5' THEN CASE
                  WHEN  COALESCE("Power", 74.0) <= 105.0 THEN 1.145943333333
                  ELSE 1.732180000000
                END
                ELSE CASE
            ...
            ELSE CASE
              WHEN  COALESCE("Power", 74.0) <= 105.0 THEN CASE
                WHEN  COALESCE("Power", 74.0) <= 73.94 THEN CASE
                  WHEN  COALESCE("Power", 74.0) <= 63.12 THEN 1.037770000000
                  ELSE 1.424066666667
                END
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 1.729460000000
                  ELSE 2.256566666667
                END
              END
              ELSE CASE
          ...
          ELSE CASE
            WHEN COALESCE("Year", 2014.0) >= 1998.0
            AND COALESCE("Year", 2014.0) < 2017.0 THEN CASE
              WHEN "Transmission" <> 'Manual' THEN CASE
                WHEN COALESCE("Year", 2014.0) >= 1998.0
                AND COALESCE("Year", 2014.0) < 2012.0 THEN CASE
              ...
              ELSE CASE
                WHEN COALESCE("Year", 2014.0) >= 1998.0
                AND COALESCE("Year", 2014.0) < 2013.0 THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2011.0 THEN 1.550726666667
                  ELSE 2.350470000000
                END
                ELSE CASE
        ...
        END
        ELSE CASE
          WHEN  COALESCE("Power", 74.0) <= 193.64000000000033 THEN CASE
            WHEN COALESCE("Year", 2014.0) >= 1998.0
            AND COALESCE("Year", 2014.0) < 2014.0 THEN CASE
              WHEN COALESCE("Year", 2014.0) >= 1998.0
              AND COALESCE("Year", 2014.0) < 2012.0 THEN CASE
                WHEN "Brand" in (
                  ...
                  WHEN  COALESCE("Power", 74.0) <= 174.33 THEN 2.754430000000
                  ELSE 4.130333333333
                END
                ELSE CASE
              ...
              ELSE CASE
                ...
                ELSE CASE
                  ...
                  AND "Kilometers_Driven" < 34687.2 THEN 10.666666666667
                  ELSE 8.000000000000
                END
              END
            END
            ELSE CASE
              WHEN COALESCE("Year", 2014.0) >= 1998.0
              AND COALESCE("Year", 2014.0) < 2016.0 THEN CASE
              ...
              ELSE CASE
                ...
                END
                ELSE CASE
                  WHEN  COALESCE("Power", 74.0) <= 174.33 THEN 5.862306666667
          ...
          ELSE CASE
            WHEN "Kilometers_Driven" >= 600.0
            AND "Kilometers_Driven" < 34687.2 THEN CASE
              WHEN "Name" <> 'Land Rover' THEN CASE
                WHEN "Brand" in ('Force', 'Isuzu', 'Lamborghini', 'Bentley', 'ISUZU') THEN 40.000000000000
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2015.0 THEN 11.833333333333
            ...
            ELSE CASE
              ...
              AND COALESCE("Year", 2014.0) < 2013.0 THEN CASE
                WHEN "Kilometers_Driven" >= 600.0
                AND "Kilometers_Driven" < 60000.0 THEN CASE
                  WHEN "Brand" in (
                    'Renault',
                    'Chevrolet',
                    'Nissan',
              ...
              ELSE CASE
                WHEN COALESCE("Engine", 1197.0) >= 24.000000000000
                AND COALESCE("Engine", 1197.0) < 2811.666666666667 THEN CASE
                  WHEN "Brand" in (
                    'Honda',
                    'Toyota',
                    'Mercedes-Benz',
                ...
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 78500.0 THEN 14.136326666667
                  ELSE 9.510333333333
                END
              END
            END
      ...
      CASE
          ...
          AND COALESCE("Engine", 1197.0) < 1968.0 THEN CASE
            ...
            AND COALESCE("Year", 2014.0) < 2014.0 THEN CASE
              WHEN "Name" <> 'Land Rover' THEN CASE
                WHEN COALESCE("Year", 2014.0) >= 1998.0
                AND COALESCE("Year", 2014.0) < 2011.0 THEN CASE
                  WHEN  COALESCE("Power", 74.0) <= 105.0 THEN 0.678910000000
                  ELSE 1.094966666667
                END
                ELSE CASE
            ...
            ELSE CASE
              WHEN  COALESCE("Power", 74.0) <= 105.0 THEN CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2017.0 THEN 1.816070000000
                  ELSE 2.430276666667
                END
              END
              ELSE CASE
                WHEN "Name" <> 'Mini Cooper' THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 2.460813333333
                  ELSE 3.643916666667
                END
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 22894.8 THEN 10.061110000000
                  ELSE 7.883333333333
                END
              END
            END
          ...
          ELSE CASE
            ...
            ELSE CASE
              ...
              AND COALESCE("Year", 2014.0) < 2017.0 THEN CASE
                ...
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 45000.0 THEN 6.676233333333
                  ELSE 5.069513333333
                END
              END
              ELSE CASE
                WHEN "Mileage" <= 13.1 THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 206.000000000000 THEN 11.666666666667
        ...
        ELSE CASE
          WHEN COALESCE("Year", 2014.0) >= 1998.0
          AND COALESCE("Year", 2014.0) < 2015.0 THEN CASE
            WHEN "Seats" <= 5.0 THEN CASE
              WHEN COALESCE("Engine", 1197.0) >= 24.000000000000
              AND COALESCE("Engine", 1197.0) < 2179.0 THEN CASE
                WHEN "Brand" in (
                  'Mahindra',
                  'BMW',
                  'Audi',
                  ...
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2013.0 THEN 7.333333333333
                  ELSE 8.594443333333
                END
                ELSE 1.916666666667
              END
              ELSE CASE
                WHEN "Brand" in (
                  ...
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2010.0 THEN 19.666666666667
            ...
            ELSE CASE
              ...
              AND COALESCE("Year", 2014.0) < 2012.0 THEN CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2010.0 THEN 3.738443333333
                  ELSE 6.937833333333
                END
              END
              ELSE CASE
          ...
          ELSE CASE
            WHEN  COALESCE("Power", 74.0) <= 193.64000000000033 THEN CASE
              WHEN "Kilometers_Driven" >= 600.0
              AND "Kilometers_Driven" < 55000.0 THEN CASE
                WHEN "Seats" <= 7.0 THEN CASE
                  WHEN COALESCE("Engine", 1197.0) >= 24.000000000000
                  AND COALESCE("Engine", 1197.0) < 1999.0 THEN 9.592733333333
                  ELSE 13.191913333333
                END
                ELSE CASE
                  WHEN  COALESCE("Power", 74.0) <= 174.33 THEN 7.013646666667
                  ELSE 9.396110000000
                END
              END
              ELSE CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 4.653333333333
            ...
            ELSE CASE
              ...
              ELSE CASE
                ...
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 34687.2 THEN 11.404763333333
                  ELSE 9.821666666667
                END
              END
            END
      ...
      CASE
          ...
          AND COALESCE("Engine", 1197.0) < 1968.0 THEN CASE
            ...
            AND COALESCE("Year", 2014.0) < 2014.0 THEN CASE
              WHEN "Name" <> 'Land Rover' THEN CASE
                ...
                AND COALESCE("Year", 2014.0) < 2012.0 THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2008.0 THEN 0.508820000000
                  ELSE 0.931176666667
                END
                ELSE CASE
                  WHEN  COALESCE("Power", 74.0) <= 98.6 THEN 1.182800000000
                  ELSE 1.829380000000
                END
              END
              ELSE CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2008.0 THEN 5.370000000000
                  ELSE 8.833333333333
                END
              END
            END
            ELSE CASE
              WHEN  COALESCE("Power", 74.0) <= 105.0 THEN CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 1.696180000000
                  ELSE 2.284520000000
                END
              END
              ELSE CASE
                WHEN "Name" <> 'Mini Cooper' THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 2.402760000000
                  ELSE 3.521763333333
                END
                ELSE CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2016.0 THEN 7.666666666667
          ...
          ELSE CASE
            ...
            AND COALESCE("Year", 2014.0) < 2016.0 THEN CASE
              WHEN "Transmission" <> 'Manual' THEN CASE
                ...
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 55000.0 THEN 5.881563333333
                  ELSE 4.078420000000
                END
              END
              ELSE CASE
        ...
        ELSE CASE
          ...
          AND COALESCE("Year", 2014.0) < 2015.0 THEN CASE
            WHEN "Seats" <= 5.0 THEN CASE
              ...
              AND COALESCE("Engine", 1197.0) < 2179.0 THEN CASE
                WHEN "Fuel_Type" <> 'Diesel' THEN CASE
                  WHEN COALESCE("Year", 2014.0) >= 1998.0
                  AND COALESCE("Year", 2014.0) < 2013.0 THEN 11.666666666667
                  ELSE 9.222223333333
                END
                ELSE 2.916666666667
              END
              ELSE CASE
                WHEN "Brand" in (
                  ...
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 40000.0 THEN 24.000000000000
            ...
            ELSE CASE
              ...
              ELSE CASE
                ...
                ELSE CASE
                  WHEN COALESCE("Engine", 1197.0) >= 24.000000000000
                  AND COALESCE("Engine", 1197.0) < 2811.666666666667 THEN 6.450666666667
          ...
          ELSE CASE
            WHEN  COALESCE("Power", 74.0) <= 193.64000000000033 THEN CASE
              WHEN COALESCE("Year", 2014.0) >= 1998.0
              AND COALESCE("Year", 2014.0) < 206.000000000000 THEN CASE
                WHEN "Kilometers_Driven" >= 600.0
                AND "Kilometers_Driven" < 29000.0 THEN CASE
              ...
              END
              ELSE CASE
                WHEN  COALESCE("Power", 74.0) <= 174.33 THEN CASE
              ...
              ELSE CASE
                WHEN "Name" <> 'Mercedes-Benz GLE' THEN CASE
                  WHEN "Brand" in (
                    ...
                    'Bentley',
                    'ISUZU'
                  ) THEN 15.908810000000
                  ELSE 10.834226666667
                END
                ELSE CASE
                  WHEN "Kilometers_Driven" >= 600.0
                  AND "Kilometers_Driven" < 45000.0 THEN 21.030000000000
