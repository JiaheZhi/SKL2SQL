...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Car_price/car_dt8.joblib"
    ...
    for group in ('org','pos', 'uncertain', 'prune', 'enum', ):
        ...
        generated_file_path = os.path.join(parent_directory, f"q5_dt8_{group}.sql")
