...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Credit_card/credit_card_dt8.joblib"
    table_name = "credit_card"
    dbms = 'duckdb'
    pre_sql = "EXPLAIN ANALYZE "

    # for group in ('enum', ):
    for group in ('org', 'pos', 'uncertain', 'prune','enum', ):
        t1 = time.time()
        ...
        # generated_file_path = os.path.join(parent_directory, f"q2_dt8_{group}.sql")
