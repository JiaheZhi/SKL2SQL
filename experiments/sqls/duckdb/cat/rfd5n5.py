...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Cat/cat_rf_d5n5_count.joblib"
    table_name = "cat"
    dbms = 'duckdb'
    ...
    for group in ('org','pos', 'uncertain', 'prune',):
        ...
        generated_file_path = os.path.join(parent_directory, f"q8_rfd5n5_{group}.sql")
