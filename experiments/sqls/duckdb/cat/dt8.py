...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Cat/cat_dt8.joblib"
    table_name = "cat"
    dbms = 'duckdb'
    ...
    for group in ('org','pos', 'uncertain', 'prune', ):
        ...
        generated_file_path = os.path.join(parent_directory, f"q7_dt8_{group}.sql")
