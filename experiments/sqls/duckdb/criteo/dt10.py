...
if __name__ == "__main__":
    ...
    pipeline_file = "/home/postgres/craftsman_experiments/new_trained_pipeline/Criteo/criteo_dt8_bnc.joblib"
    table_name = "criteo"
    dbms = 'duckdb'
    ...
    for group in ('org','pos', 'uncertain', 'prune',):
        ...
        generated_file_path = os.path.join(parent_directory, f"q9_dt10_{group}.sql")
