    ...
    FROM
      (
        SELECT
            ...
            WHEN "Station" <= 0.5 THEN CASE
              WHEN "Traffic_Signal" <= 0.5 THEN CASE
                WHEN "Weather_Condition" <= 243999.0 THEN CASE
                  WHEN "Weather_Condition" <= 49910.5 THEN CASE
              ...
              ELSE CASE
                ...
                ELSE CASE
                  WHEN "Weather_Condition" <= 562510.5 THEN CASE
                    WHEN "Weather_Condition" <= 275457.5 THEN 1.0
                    ELSE 1.0
                  END
                  ELSE CASE
          ...
          CASE
            WHEN "Weather_Condition" <= 243999.0 THEN CASE
              WHEN "Weather_Condition" <= 226073.0 THEN CASE
            ...
            ELSE CASE
              WHEN "Weather_Condition" <= 243999.0 THEN CASE
                WHEN "Station" <= 0.5 THEN CASE
                  ...
                  END
                  ELSE CASE
                    WHEN "Weather_Condition" <= 226073.0 THEN 1.0
                    ELSE 1.0
                  END
                END
                ELSE CASE
