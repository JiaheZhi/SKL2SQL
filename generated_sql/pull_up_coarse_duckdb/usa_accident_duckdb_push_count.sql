          ...
          CASE
            WHEN "Source_1" <= 0.5 THEN CASE
              WHEN "Source_2" <= 0.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 71.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 1.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Start_Time" <= 24235.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 1.5 THEN 1.0
                              ELSE 2.0
                            END
                          END
                        END
                ...
                END
                ELSE CASE
                  WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 2.5 THEN CASE
                    WHEN "Description" <= 15.5 THEN CASE
                      WHEN "Zipcode" <= 134.5 THEN CASE
                        WHEN "Start_Time" <= 24248.5 THEN CASE
                          WHEN "Start_Time" <= 24242.5 THEN CASE
                            WHEN "Timezone_3" <= 0.5 THEN CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 0.5 THEN 3.0
                              ELSE 3.0
                            END
                            ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 0.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Zipcode" <= 248.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 0.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Start_Time" <= 24227.5 THEN CASE
                            WHEN "Timezone_0" <= 0.5 THEN CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Source_2" <= 0.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 2.0 THEN CASE
                    ...
                    WHEN "Temperature(F)" <= 4.353809356689453 THEN CASE
                      WHEN "Pressure(in)" <= 29.60422134399414 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Visibility(mi)" <= 2.8168505430221558 THEN CASE
                            WHEN "Start_Time" <= 24269.5 THEN CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 1.5 THEN 2.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_6" <= 0.5 THEN 2.0
                        ...
                        ELSE CASE
                          WHEN "Description" <= 9.5 THEN CASE
                            WHEN "Zipcode" <= 26.5 THEN CASE
                              WHEN list_aggregate(list_transform(['rain', 'snow', 'fog', 'wind', 'thunder', 'storm', 'drizzle', 'sand', 'whirlwind'], x->(contains(lower(COALESCE("Weather_Condition", 'Fair')),x)::BIGINT)),'sum') <= 2.0 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
