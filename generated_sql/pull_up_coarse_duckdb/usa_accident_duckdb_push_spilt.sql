        ...
        SELECT
          CASE
            WHEN "Source_1" <= 0.5 THEN CASE
              WHEN "Source_2" <= 0.5 THEN CASE
                WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                      ...
                      WHEN "Airport_Code_6" <= 0.5 THEN CASE
                        WHEN "Airport_Code_1" <= 0.5 THEN CASE
                          WHEN "Pressure(in)" <= 21.53580665588379 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 4.5 THEN 1.0
                            ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24248.0 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_4" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24249.5 THEN CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24244.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN CASE
                              WHEN "Start_Time" <= 24242.5 THEN 2.0
                              ELSE 2.0
                            END
                            ELSE CASE
                    ...
                    WHEN "Timezone_3" <= 0.5 THEN CASE
                      WHEN "Airport_Code_2" <= 0.5 THEN CASE
                        WHEN "Timezone_1" <= 0.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 3.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_3" <= 0.5 THEN CASE
                            WHEN "Zipcode" <= 97.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 5.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Pressure(in)" <= 28.066664695739746 THEN CASE
                              WHEN "Start_Time" <= 24270.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 71.5 THEN CASE
                        WHEN "Airport_Code_9" <= 0.5 THEN CASE
                          WHEN "Start_Time" <= 24233.5 THEN CASE
                            WHEN "Airport_Code_0" <= 0.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Start_Time" <= 24235.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 6.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Start_Time" <= 24242.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                ...
                ELSE CASE
                  WHEN "Weather_Condition" <= 2.5 THEN CASE
                    WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 15.5 THEN CASE
                      WHEN "Zipcode" <= 134.5 THEN CASE
                        WHEN "Start_Time" <= 24248.5 THEN CASE
                          WHEN "Start_Time" <= 24242.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN 1.0
                              ELSE 3.0
                            END
                          END
                          ELSE CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN CASE
                            WHEN "Airport_Code_1" <= 0.5 THEN CASE
                      ...
                      END
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                          WHEN "Start_Time" <= 24248.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN CASE
                              WHEN "Pressure(in)" <= 30.029929161071777 THEN 1.0
                              ELSE 3.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24220.5 THEN 3.0
                              ELSE 3.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      WHEN "Timezone_3" <= 0.5 THEN CASE
                        WHEN "Humidity(%)" <= 3.944926619529724 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 35.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 30.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_0" <= 0.5 THEN CASE
                            WHEN "Temperature(F)" <= 3.4276353120803833 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 31.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24245.0 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Temperature(F)" <= 8.628458023071289 THEN CASE
                            WHEN "Wind_Chill(F)" <= 1.8928253650665283 THEN CASE
                              WHEN "Start_Time" <= 24243.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_1" <= 0.5 THEN 1.0
                  ...
                  ELSE CASE
                      ...
                      WHEN "Timezone_3" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Temperature(F)" <= 4.092580556869507 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.0 THEN 1.0
                              ELSE 3.0
                            END
                          END
                          ELSE CASE
                    ...
                    END
                    ELSE CASE
                      WHEN "Start_Time" <= 24226.0 THEN 3.0
                      ELSE CASE
              ...
              ELSE CASE
                WHEN "Start_Time" <= 24268.5 THEN CASE
                  WHEN "Temperature(F)" <= 2.6729750633239746 THEN CASE
                    WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                        WHEN "Pressure(in)" <= 29.764487266540527 THEN CASE
                          WHEN "Start_Time" <= 24267.5 THEN CASE
                            WHEN "Timezone_2" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24242.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_3" <= 0.5 THEN 1.0
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24216.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 20.5 THEN CASE
                        WHEN "Humidity(%)" <= 3.770565152168274 THEN CASE
                          WHEN "Start_Time" <= 24203.5 THEN 2.0
                          ELSE CASE
                        ...
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24214.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 15.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Humidity(%)" <= 4.20646858215332 THEN CASE
                            WHEN "Airport_Code_9" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                        ...
                        WHEN "Zipcode" <= 248.5 THEN CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            WHEN "Wind_Chill(F)" <= 4.252711534500122 THEN CASE
                              WHEN "Start_Time" <= 24234.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 55.5 THEN CASE
                        WHEN "Zipcode" <= 9.5 THEN CASE
                          WHEN "Airport_Code_0" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.5 THEN CASE
                              WHEN "Start_Time" <= 24267.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_5" <= 0.5 THEN 1.0
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN 0.0
                              ELSE 1.0
                            END
                          END
                        END
                ...
                ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_9" <= 0.5 THEN CASE
                            WHEN "Zipcode" <= 1516.0 THEN CASE
                              WHEN "Start_Time" <= 24269.5 THEN 0.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24271.5 THEN 0.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN 0.0
                              ELSE 1.0
                            END
                          END
                        END
                  ...
                  ELSE CASE
                      ...
                      WHEN "Zipcode" <= 20.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.5 THEN 0.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Weather_Condition" <= 0.5 THEN CASE
                          WHEN "Pressure(in)" <= 29.664320945739746 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 20.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 78.0 THEN CASE
                        WHEN "Wind_Chill(F)" <= 4.2281293869018555 THEN CASE
                          WHEN "Wind_Chill(F)" <= 4.056054353713989 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 19.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                      ...
                      END
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24229.5 THEN CASE
                              WHEN "Zipcode" <= 12.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    WHEN "Start_Time" <= 24268.5 THEN CASE
                      WHEN "Timezone_0" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24230.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                              WHEN "Start_Time" <= 24228.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_5" <= 0.5 THEN 1.0
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_6" <= 0.5 THEN CASE
                            WHEN "Start_Time" <= 24239.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_8" <= 0.5 THEN CASE
                          WHEN "Airport_Code_5" <= 0.5 THEN CASE
                            WHEN "Start_Time" <= 24209.5 THEN CASE
                              WHEN "Airport_Code_0" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Pressure(in)" <= 29.72442054748535 THEN CASE
                              WHEN "Start_Time" <= 24240.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                      ...
                      WHEN "Timezone_1" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Temperature(F)" <= 4.564903020858765 THEN CASE
                            WHEN "Airport_Code_8" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN 0.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_10" <= 0.5 THEN 1.0
                  ...
                  WHEN "Zipcode" <= 11.5 THEN CASE
                    WHEN "Wind_Chill(F)" <= 0.24827969074249268 THEN CASE
                      WHEN "Zipcode" <= 4.5 THEN CASE
                        WHEN "Visibility(mi)" <= 3.19243061542511 THEN CASE
                          WHEN "Airport_Code_7" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN 1.0
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_3" <= 0.5 THEN CASE
                          WHEN "Airport_Code_0" <= 0.5 THEN CASE
                            WHEN "Pressure(in)" <= 30.681011199951172 THEN CASE
                              WHEN "Start_Time" <= 24259.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE 1.0
                          END
                        ...
                        ELSE CASE
                          WHEN "Humidity(%)" <= 3.6397942304611206 THEN CASE
                            WHEN "Airport_Code_0" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24264.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                              WHEN "Timezone_1" <= 0.5 THEN 1.0
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_5" <= 0.5 THEN CASE
                        WHEN "Airport_Code_0" <= 0.5 THEN CASE
                          WHEN "Airport_Code_7" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24227.5 THEN CASE
                            WHEN "Timezone_0" <= 0.5 THEN CASE
                              WHEN "Weather_Condition" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.5 THEN CASE
                  ...
                  ELSE CASE
                    WHEN "Airport_Code_0" <= 0.5 THEN CASE
                      WHEN "Wind_Chill(F)" <= 3.5644114017486572 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_8" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 17.5 THEN CASE
                              WHEN "Airport_Code_5" <= 0.5 THEN 2.0
                              ELSE 2.0
                            END
                            ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 31.0 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Start_Time" <= 24225.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                            WHEN "Humidity(%)" <= 0.6756503880023956 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_4" <= 0.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 20.5 THEN CASE
                            WHEN "Zipcode" <= 20.5 THEN CASE
                              WHEN "Timezone_0" <= 0.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24261.5 THEN CASE
                  ...
                  WHEN "Visibility(mi)" <= 0.29107455909252167 THEN CASE
                    WHEN "Zipcode" <= 283.5 THEN CASE
                      WHEN "Zipcode" <= 17.5 THEN CASE
                        WHEN "Start_Time" <= 24270.5 THEN CASE
                          WHEN "Airport_Code_10" <= 0.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_2" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 21.0 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Temperature(F)" <= 1.926230788230896 THEN CASE
                          WHEN "Start_Time" <= 24216.5 THEN 2.0
                          ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Pressure(in)" <= 29.79453754425049 THEN CASE
                            WHEN "Airport_Code_9" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24241.0 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_8" <= 0.5 THEN 1.0
                    ...
                    ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Temperature(F)" <= 2.9816997051239014 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Weather_Condition" <= 1.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Weather_Condition" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24217.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                ...
                ELSE CASE
                  WHEN "Airport_Code_3" <= 0.5 THEN CASE
                    WHEN "Airport_Code_7" <= 0.5 THEN CASE
                      WHEN "Airport_Code_9" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24225.5 THEN CASE
                          WHEN "Start_Time" <= 24195.5 THEN CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                              WHEN "Start_Time" <= 24265.5 THEN 1.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24225.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_5" <= 0.5 THEN CASE
                            WHEN "Zipcode" <= 53.5 THEN CASE
                              WHEN "Start_Time" <= 24269.0 THEN 1.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24233.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24268.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                          WHEN "Zipcode" <= 848.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24266.5 THEN 1.0
                              ELSE 0.0
                            END
                          END
                          ELSE CASE
                  ...
                  ELSE CASE
                        ...
                        WHEN "Airport_Code_5" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Zipcode" <= 1734.5 THEN CASE
                              WHEN "Start_Time" <= 24247.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_8" <= 0.5 THEN 2.0
                    ...
                    ELSE CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                        WHEN "Airport_Code_7" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_8" <= 0.5 THEN 1.0
                            ELSE CASE
                              WHEN "Start_Time" <= 24259.5 THEN 1.0
                              ELSE 0.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN CASE
                          WHEN "Start_Time" <= 24234.5 THEN CASE
          ...
          CASE
                  ...
                  WHEN "Start_Time" <= 24243.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_4" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_5" <= 0.5 THEN CASE
                            WHEN "Start_Time" <= 24211.5 THEN CASE
                              WHEN "Airport_Code_2" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_1" <= 0.5 THEN CASE
                          WHEN "Source_0" <= 0.5 THEN CASE
                            WHEN "Airport_Code_3" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24212.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN 1.0
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_2" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24213.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                      ...
                      ELSE CASE
                        WHEN "Source_0" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24244.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN 2.0
                              ELSE 3.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      WHEN "Temperature(F)" <= 3.5094341039657593 THEN CASE
                        WHEN "Airport_Code_9" <= 0.5 THEN CASE
                          WHEN "Zipcode" <= 708.0 THEN CASE
                            WHEN "Start_Time" <= 24245.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN 1.0
                              ELSE 3.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_8" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24245.5 THEN 0.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_2" <= 0.5 THEN 0.0
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24244.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24241.5 THEN CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        WHEN "Source_2" <= 0.5 THEN CASE
                          WHEN "Airport_Code_2" <= 0.5 THEN CASE
                            WHEN "Zipcode" <= 7.5 THEN CASE
                              WHEN "Start_Time" <= 24219.5 THEN 3.0
                              ELSE 3.0
                            END
                            ELSE CASE
                      ...
                      WHEN "Zipcode" <= 120.0 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Humidity(%)" <= 0.850011795759201 THEN CASE
                            WHEN "Airport_Code_7" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24207.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN 1.0
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_9" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24237.0 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.0 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_2" <= 0.5 THEN CASE
                            WHEN "Zipcode" <= 11.5 THEN CASE
                              WHEN "Start_Time" <= 24245.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN 2.0
                              ELSE 3.0
                            END
                          END
                        END
                    ...
                    WHEN "Pressure(in)" <= 25.35715961456299 THEN CASE
                      WHEN "Airport_Code_8" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24256.5 THEN CASE
                              WHEN "Temperature(F)" <= 4.195488929748535 THEN 1.0
                              ELSE 3.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Pressure(in)" <= 23.103412628173828 THEN CASE
                          WHEN "Temperature(F)" <= 2.453965187072754 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 39.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 33.5 THEN CASE
                              WHEN "Airport_Code_6" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_10" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 47.0 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                        WHEN "Wind_Chill(F)" <= 1.6470038890838623 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Timezone_0" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24262.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24277.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                  ...
                  ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Zipcode" <= 97.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 52.0 THEN CASE
                            WHEN "Wind_Chill(F)" <= 3.023604154586792 THEN CASE
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24275.5 THEN CASE
                          WHEN "Airport_Code_4" <= 0.5 THEN CASE
                            WHEN "Wind_Chill(F)" <= 1.6470038890838623 THEN CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                              ELSE 1.0
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 44.5 THEN 1.0
                              ELSE 3.0
                            END
                          END
                        END
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24278.5 THEN 1.0
                              ELSE 3.0
                            END
                          END
                        END
                    ...
                    WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Wind_Chill(F)" <= 2.6794540882110596 THEN CASE
                          WHEN "Airport_Code_8" <= 0.5 THEN CASE
                            WHEN "Start_Time" <= 24269.0 THEN CASE
                              WHEN "Start_Time" <= 24252.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE 0.0
                          END
                      ...
                      ELSE CASE
                        WHEN "Timezone_3" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24253.0 THEN 1.0
                              ELSE 2.0
                            END
                          END
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24264.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Start_Time" <= 24268.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24258.5 THEN 1.0
                            ELSE 2.0
                          END
                        END
                      END
                      ELSE CASE
                        WHEN "Humidity(%)" <= 3.073119640350342 THEN CASE
                          ...
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                              WHEN "Start_Time" <= 24270.5 THEN 0.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_10" <= 0.5 THEN 2.0
            ...
            ELSE CASE
                    ...
                    WHEN "Zipcode" <= 23.5 THEN CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN CASE
                        WHEN "Timezone_0" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Temperature(F)" <= 3.773301362991333 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN 0.0
                              ELSE 0.0
                            END
                            ELSE CASE
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24208.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 17.5 THEN CASE
                            WHEN "Timezone_0" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24195.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.5 THEN 1.0
                      ...
                      WHEN "Zipcode" <= 31.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24203.5 THEN 1.0
                              ELSE 2.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN CASE
                          WHEN "Pressure(in)" <= 30.135103225708008 THEN CASE
                            WHEN "Airport_Code_2" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24272.5 THEN 0.0
                              ELSE 0.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN 0.0
                    ...
                    WHEN "Zipcode" <= 37.5 THEN CASE
                      WHEN "Airport_Code_1" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24271.5 THEN CASE
                              WHEN "Humidity(%)" <= 4.075697660446167 THEN 1.0
                              ELSE 0.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24235.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                    ...
                    WHEN "Humidity(%)" <= 4.075697660446167 THEN CASE
                      WHEN "Visibility(mi)" <= 3.19243061542511 THEN CASE
                        WHEN "Airport_Code_5" <= 0.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN "Start_Time" <= 24205.5 THEN CASE
                              WHEN "Airport_Code_3" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24263.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Temperature(F)" <= 4.008143186569214 THEN CASE
                          WHEN "Airport_Code_8" <= 0.5 THEN CASE
                            WHEN "Timezone_1" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN 2.0
                              ELSE 2.0
                            END
                            ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Timezone_1" <= 0.5 THEN CASE
                            WHEN "Humidity(%)" <= 0.6320600509643555 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.0 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                      ...
                      WHEN "Zipcode" <= 14.5 THEN CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 17.5 THEN CASE
                          WHEN "Timezone_1" <= 0.5 THEN CASE
                            ...
                            ELSE CASE
                              WHEN "Start_Time" <= 24252.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 21.5 THEN CASE
                            WHEN "Humidity(%)" <= 4.119287967681885 THEN CASE
                              WHEN "Start_Time" <= 24236.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_3" <= 0.5 THEN 1.0
              ...
              END
              ELSE CASE
                WHEN "Start_Time" <= 24232.5 THEN CASE
                      ...
                      WHEN "Wind_Chill(F)" <= 1.143069863319397 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Temperature(F)" <= 1.2428146004676819 THEN CASE
                            WHEN "Start_Time" <= 24217.0 THEN 1.0
                            ELSE CASE
                              WHEN "Start_Time" <= 24218.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 17.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Zipcode" <= 525.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24201.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_10" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.0 THEN CASE
                              WHEN "Airport_Code_8" <= 0.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE 1.0
                  ...
                  ELSE CASE
                    WHEN "Airport_Code_2" <= 0.5 THEN CASE
                      WHEN "Airport_Code_7" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24200.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.0 THEN 2.0
                            ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Zipcode" <= 39.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24227.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_5" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_3" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24223.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Weather_Condition" <= 0.5 THEN 2.0
                        ...
                        WHEN "Zipcode" <= 621.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Zipcode" <= 88.5 THEN CASE
                              WHEN "Start_Time" <= 24197.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                ...
                ELSE CASE
                  WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_8" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24243.5 THEN CASE
                          WHEN "Airport_Code_3" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24234.0 THEN 2.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            WHEN "Pressure(in)" <= 28.352139472961426 THEN CASE
                              WHEN "Start_Time" <= 24239.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_1" <= 0.5 THEN 1.0
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24240.5 THEN CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 6.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Zipcode" <= 667.0 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.5 THEN 0.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_2" <= 0.5 THEN 2.0
              ...
              WHEN "Airport_Code_3" <= 0.5 THEN CASE
                WHEN "Zipcode" <= 9.5 THEN CASE
                        ...
                        WHEN "Wind_Chill(F)" <= 4.646025896072388 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Temperature(F)" <= 4.617676258087158 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN 0.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_5" <= 0.5 THEN 1.0
                      ...
                      ELSE CASE
                        WHEN "Start_Time" <= 24268.5 THEN CASE
                          WHEN "Airport_Code_6" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 17.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                  ...
                  ELSE CASE
                    WHEN "Timezone_3" <= 0.5 THEN CASE
                      WHEN "Airport_Code_0" <= 0.5 THEN CASE
                        WHEN "Start_Time" <= 24247.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_2" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 31.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 35.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 28.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Pressure(in)" <= 30.02492046356201 THEN CASE
                          WHEN "Airport_Code_5" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24247.5 THEN 3.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      WHEN "Wind_Chill(F)" <= 3.5644114017486572 THEN CASE
                        WHEN "Start_Time" <= 24249.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Wind_Chill(F)" <= 2.777782678604126 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 13.5 THEN 3.0
                              ELSE 3.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                            WHEN "Start_Time" <= 24202.5 THEN CASE
                ...
                ELSE CASE
                  WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN CASE
                    WHEN "Start_Time" <= 24246.5 THEN CASE
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24224.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                            WHEN "Airport_Code_6" <= 0.5 THEN CASE
                              WHEN "Visibility(mi)" <= 1.3145302534103394 THEN 1.0
                              ELSE 1.0
                  ...
                  ELSE CASE
                    WHEN "Timezone_0" <= 0.5 THEN CASE
                      WHEN "Temperature(F)" <= 3.4276353120803833 THEN CASE
                        WHEN "Source_1" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24249.5 THEN 3.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Temperature(F)" <= 4.103135347366333 THEN CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            WHEN "Wind_Chill(F)" <= 3.6135756969451904 THEN CASE
                              WHEN "Start_Time" <= 24249.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24248.5 THEN 1.0
                    ...
                    ELSE CASE
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24247.0 THEN CASE
                          WHEN "Pressure(in)" <= 30.14512062072754 THEN CASE
                            WHEN "Start_Time" <= 24218.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_0" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24261.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_10" <= 0.5 THEN 1.0
                      ...
                      WHEN "Airport_Code_0" <= 0.5 THEN CASE
                        WHEN "Source_0" <= 0.5 THEN CASE
                          WHEN "Timezone_2" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24196.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                    ...
                    WHEN "Source_1" <= 0.5 THEN CASE
                      WHEN "Zipcode" <= 2.5 THEN CASE
                        WHEN "Wind_Chill(F)" <= 1.7035428285598755 THEN CASE
                          WHEN "Airport_Code_0" <= 0.5 THEN CASE
                            WHEN "Start_Time" <= 24247.0 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 15.5 THEN 3.0
                              ELSE 3.0
                            END
                            ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_1" <= 0.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 32.5 THEN CASE
                ...
                ELSE CASE
                  WHEN "Wind_Chill(F)" <= 3.466082811355591 THEN CASE
                    WHEN "Source_0" <= 0.5 THEN CASE
                      WHEN "Airport_Code_4" <= 0.5 THEN CASE
                        WHEN "Visibility(mi)" <= 1.3145302534103394 THEN CASE
                          ...
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                              WHEN "Start_Time" <= 24217.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_8" <= 0.5 THEN 2.0
                    ...
                    ELSE CASE
                      WHEN "Start_Time" <= 24247.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24226.5 THEN CASE
                            WHEN "Start_Time" <= 24204.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_1" <= 0.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_7" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 47.5 THEN 1.0
                              ELSE 3.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_10" <= 0.5 THEN 1.0
                  ...
                  ELSE CASE
                      ...
                      WHEN "Airport_Code_0" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Pressure(in)" <= 29.52408790588379 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 33.5 THEN 1.0
                              ELSE 3.0
                            END
                          END
                          ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Pressure(in)" <= 28.642621994018555 THEN CASE
                            WHEN "Airport_Code_8" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24242.5 THEN 3.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Zipcode" <= 7.5 THEN 1.0
                    ...
                    ELSE CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN CASE
                        WHEN "Airport_Code_0" <= 0.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 5.5 THEN CASE
                  ...
                  WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                    WHEN "Pressure(in)" <= 25.076693534851074 THEN CASE
                      WHEN "Zipcode" <= 146.0 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24238.5 THEN CASE
                            WHEN "Zipcode" <= 39.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Timezone_2" <= 0.5 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 6.5 THEN 1.0
                            ELSE CASE
                  ...
                  ELSE CASE
                    WHEN "Zipcode" <= 525.5 THEN CASE
                      WHEN "Temperature(F)" <= 1.5277912616729736 THEN CASE
                        WHEN "Start_Time" <= 24223.0 THEN CASE
                          WHEN "Airport_Code_4" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24241.0 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_8" <= 0.5 THEN CASE
                          WHEN "Visibility(mi)" <= 2.8168505430221558 THEN CASE
                            WHEN "Start_Time" <= 24224.5 THEN CASE
                              WHEN "Start_Time" <= 24209.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Timezone_1" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24238.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24210.0 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                    ...
                    WHEN "Timezone_3" <= 0.5 THEN CASE
                      WHEN "Zipcode" <= 334.0 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Timezone_2" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 18.5 THEN 2.0
                              ELSE 2.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_1" <= 0.5 THEN 1.0
                      ...
                      WHEN "Source_1" <= 0.5 THEN CASE
                        WHEN "Source_0" <= 0.5 THEN CASE
                          WHEN "Pressure(in)" <= 28.512405395507812 THEN CASE
                            WHEN "Airport_Code_1" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 21.5 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                    ...
                    WHEN "Airport_Code_1" <= 0.5 THEN CASE
                      WHEN "Timezone_3" <= 0.5 THEN CASE
                        WHEN "Wind_Chill(F)" <= 3.6627399921417236 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 50.5 THEN CASE
                              WHEN "Zipcode" <= 36.5 THEN 3.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24257.5 THEN 3.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      END
                      ELSE CASE
                        WHEN "Start_Time" <= 24257.5 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24275.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      WHEN "Airport_Code_5" <= 0.5 THEN CASE
                        WHEN "Temperature(F)" <= 3.034473180770874 THEN CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 18.0 THEN 1.0
                              ELSE 2.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Weather_Condition" <= 0.5 THEN CASE
                            WHEN "Airport_Code_10" <= 0.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 36.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Timezone_1" <= 0.5 THEN 1.0
                      ...
                      WHEN "Wind_Chill(F)" <= 3.466082811355591 THEN CASE
                        WHEN "Humidity(%)" <= 2.288493275642395 THEN CASE
                          WHEN "Pressure(in)" <= 24.46567726135254 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24261.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                      ...
                      WHEN "Airport_Code_8" <= 0.5 THEN CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                          WHEN "Wind_Chill(F)" <= 4.3510401248931885 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24257.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                        END
            ...
            WHEN "Source_1" <= 0.5 THEN CASE
                  ...
                  WHEN "Timezone_0" <= 0.5 THEN CASE
                    WHEN "Wind_Chill(F)" <= 3.711904287338257 THEN CASE
                      WHEN "Timezone_3" <= 0.5 THEN CASE
                        WHEN "Airport_Code_9" <= 0.5 THEN CASE
                          WHEN "Airport_Code_2" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                              WHEN "Start_Time" <= 24225.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Timezone_1" <= 0.5 THEN 1.0
                    ...
                    ELSE CASE
                      WHEN "Airport_Code_8" <= 0.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN "Start_Time" <= 24241.0 THEN CASE
                            WHEN "Airport_Code_0" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24236.5 THEN 1.0
                              ELSE 1.0
                            END
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Zipcode" <= 107.5 THEN CASE
                            WHEN "Start_Time" <= 24239.0 THEN CASE
                    ...
                    ELSE CASE
                        ...
                        WHEN "Temperature(F)" <= 1.8602639436721802 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Visibility(mi)" <= 0.8450551629066467 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 4.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_3" <= 0.5 THEN 1.0
                      ...
                      ELSE CASE
                        WHEN "Wind_Chill(F)" <= 3.6135756969451904 THEN CASE
                          ...
                          END
                          ELSE CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 4.5 THEN CASE
                              WHEN "Weather_Condition" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    WHEN "Source_0" <= 0.5 THEN CASE
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_7" <= 0.5 THEN CASE
                          WHEN "Airport_Code_10" <= 0.5 THEN CASE
                            WHEN "Airport_Code_6" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24233.0 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Pressure(in)" <= 30.004886627197266 THEN 1.0
                          ...
                          ELSE CASE
                            WHEN "Pressure(in)" <= 28.933104515075684 THEN CASE
                              WHEN "Start_Time" <= 24239.5 THEN 2.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_8" <= 0.5 THEN 2.0
                      ...
                      WHEN "Airport_Code_5" <= 0.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Humidity(%)" <= 4.293649435043335 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN 3.0
                              ELSE 3.0
                            END
                          END
                          ELSE CASE
                            ...
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 16.0 THEN 0.0
                              ELSE 1.0
                            END
                          END
                        END
                      ...
                      ELSE CASE
                        WHEN "Wind_Chill(F)" <= 1.526551365852356 THEN CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24243.5 THEN 3.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_1" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24234.0 THEN 3.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
              ...
              ELSE CASE
                WHEN "Pressure(in)" <= 29.744454383850098 THEN CASE
                  WHEN "Start_Time" <= 24268.5 THEN CASE
                    WHEN "Humidity(%)" <= 1.5474573969841003 THEN CASE
                      WHEN "Source_2" <= 0.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 53.5 THEN CASE
                            WHEN "Start_Time" <= 24249.5 THEN CASE
                              WHEN "Airport_Code_3" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24266.5 THEN 2.0
                              ELSE 1.0
                            END
                          END
                        END
                    ...
                    ELSE CASE
                      WHEN "Timezone_1" <= 0.5 THEN CASE
                        ...
                        END
                        ELSE CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 42.5 THEN CASE
                            WHEN "Airport_Code_0" <= 0.5 THEN CASE
                              WHEN "Airport_Code_7" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                          ...
                          ELSE CASE
                            WHEN "Zipcode" <= 78.0 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 50.5 THEN 1.0
                              ELSE 3.0
                            END
                            ELSE CASE
                              WHEN "Airport_Code_1" <= 0.5 THEN 1.0
                  ...
                  ELSE CASE
                    WHEN "Airport_Code_0" <= 0.5 THEN CASE
                      WHEN "Start_Time" <= 24272.5 THEN CASE
                        WHEN "Source_0" <= 0.5 THEN CASE
                          WHEN "Airport_Code_9" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Zipcode" <= 112.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 29.5 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                      ...
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 10.5 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Pressure(in)" <= 28.878013610839844 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 2.5 THEN CASE
                              WHEN "Airport_Code_4" <= 0.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                ...
                ELSE CASE
                  WHEN "Airport_Code_0" <= 0.5 THEN CASE
                      ...
                      WHEN "Humidity(%)" <= 3.334661602973938 THEN CASE
                        ...
                        ELSE CASE
                          WHEN "Temperature(F)" <= 4.512129783630371 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24269.5 THEN 2.0
                              ELSE 0.0
                            END
                          END
                          ELSE CASE
                    ...
                    ELSE CASE
                      ...
                      END
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 36.5 THEN CASE
                          WHEN "Timezone_3" <= 0.5 THEN CASE
                  ...
                  ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Pressure(in)" <= 29.954803466796875 THEN CASE
                            WHEN "Wind_Chill(F)" <= 3.883979320526123 THEN CASE
                              WHEN "Start_Time" <= 24276.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE 0.0
                          END
                    ...
                    ELSE CASE
                      ...
                      END
                      ELSE CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 29.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 14.5 THEN CASE
                            WHEN "Airport_Code_5" <= 0.5 THEN CASE
                              WHEN "Wind_Chill(F)" <= 4.547697305679321 THEN 1.0
                              ELSE 3.0
            ...
            ELSE CASE
                    ...
                    WHEN "Temperature(F)" <= 4.195488929748535 THEN CASE
                      WHEN "Humidity(%)" <= 3.1167099475860596 THEN CASE
                        WHEN "Airport_Code_9" <= 0.5 THEN CASE
                          WHEN "Temperature(F)" <= 3.8788483142852783 THEN CASE
                            WHEN "Zipcode" <= 71.5 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN 0.0
                              ELSE 1.0
                            END
                            ELSE CASE
                        ...
                        WHEN "Humidity(%)" <= 3.0295292139053345 THEN CASE
                          WHEN "Humidity(%)" <= 1.6346380710601807 THEN CASE
                            WHEN "Pressure(in)" <= 25.65765953063965 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.0 THEN 1.0
                              ELSE 2.0
                            END
                            ELSE CASE
                  ...
                  WHEN "Zipcode" <= 133.0 THEN CASE
                    WHEN "Airport_Code_3" <= 0.5 THEN CASE
                      WHEN "Wind_Chill(F)" <= 5.039340257644653 THEN CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Airport_Code_7" <= 0.5 THEN CASE
                              WHEN "Start_Time" <= 24211.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                    ...
                    ELSE CASE
                      ...
                      ELSE CASE
                        WHEN "Start_Time" <= 24209.5 THEN CASE
                          WHEN "Airport_Code_7" <= 0.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 22.5 THEN CASE
                    ...
                    WHEN "Temperature(F)" <= 3.0133637189865112 THEN CASE
                      WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 8.5 THEN CASE
                        WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 7.5 THEN CASE
                          ...
                          ELSE CASE
                            WHEN "Start_Time" <= 24237.5 THEN CASE
                              WHEN "Start_Time" <= 24220.5 THEN 1.0
                              ELSE 1.0
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24243.5 THEN 1.0
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_10" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24270.0 THEN 1.0
                              ELSE 0.0
                            END
                          END
                          ELSE CASE
              ...
              ELSE CASE
                WHEN "Zipcode" <= 16.5 THEN CASE
                  WHEN "Airport_Code_0" <= 0.5 THEN CASE
                    WHEN "Start_Time" <= 24268.5 THEN CASE
                      WHEN "Start_Time" <= 24250.5 THEN CASE
                        WHEN "Pressure(in)" <= 29.79453754425049 THEN CASE
                          WHEN "Zipcode" <= 9.5 THEN CASE
                            WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 11.5 THEN CASE
                              WHEN "Humidity(%)" <= 3.988516926765442 THEN 1.0
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24207.0 THEN 1.0
                              ELSE 1.0
                            END
                          END
                          ELSE CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Airport_Code_6" <= 0.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24251.0 THEN 1.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                  ...
                  WHEN "Start_Time" <= 24268.5 THEN CASE
                    ...
                    ELSE CASE
                      WHEN "Pressure(in)" <= 28.943121910095215 THEN CASE
                        WHEN "Temperature(F)" <= 2.612285614013672 THEN CASE
                          WHEN "Start_Time" <= 24253.5 THEN CASE
                            WHEN "Humidity(%)" <= 4.075697660446167 THEN CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Start_Time" <= 24225.5 THEN CASE
                            WHEN "Start_Time" <= 24210.5 THEN CASE
                    ...
                    WHEN "Humidity(%)" <= 2.7679871320724487 THEN CASE
                      ...
                      ELSE CASE
                        ...
                        ELSE CASE
                          ...
                          ELSE CASE
                            WHEN "Visibility(mi)" <= 3.568010687828064 THEN CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.0 THEN 0.0
                              ELSE 2.0
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 9.5 THEN 0.0
                      ...
                      ELSE CASE
                        WHEN "Airport_Code_5" <= 0.5 THEN CASE
                          WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 12.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN "Start_Time" <= 24270.5 THEN 2.0
                              ELSE 2.0
                            END
                          END
                          ELSE CASE
                        ...
                        ELSE CASE
                          WHEN "Zipcode" <= 58.5 THEN CASE
                            ...
                            END
                            ELSE CASE
                              WHEN len(string_split(COALESCE("Description", 'A crash has occurred causing no to minimum delays. Use caution.'), ' ')) <= 25.5 THEN 2.0
                              ELSE 3.0
                            END
                          END
                          ELSE CASE
