            ...
            FROM
              (
                SELECT
                  ...
                  "Weather_Condition"
                 FROM( select * from usa_accident where index_id >= 80000  and index_id < 900000  ) as usa_accident
            ...
            FROM
              (
                SELECT
                  ...
                  time_months("Start_Time") AS "Start_Time",
                  "Weather_Condition"
                 FROM( select * from usa_accident where index_id >= 90000  and index_id < 100000  ) as usa_accident
                  LEFT JOIN usa_accident_zipcode_map on COALESCE(usa_accident."Zipcode", '91761')=usa_accident_zipcode_map."Zipcode" LEFT JOIN 
                  Airport_Code on COALESCE(usa_accident."Airport_Code", 'KCQT')=Airport_Code.Airport_Code
              ) AS data
          ) AS data
